...
// ==========================================
// RUTAS MODULARIZADAS (Desde sus carpetas)
// ==========================================
...
// =========== NUEVA RUTA DE VACANTES ===========
const vacantesRoutes = require('./src/Vacantes/vacantes.routes');
app.use('/api/vacantes', vacantesRoutes);


// ==========================================
// RUTAS DIRECTAS PARA POSTULACIONES Y PASANTÍAS
// ==========================================
...
app.post('/api/postulaciones', (req, res) => {
    ...
    fs.readFile(dbPath, 'utf8', (err, data) => {
        ...
        try {
            ...
            // Al postularse, marcamos la pasantía como "aplicada" para el estudiante
            if (db.pasantias) {
            ...
            fs.writeFile(dbPath, JSON.stringify(db, null, 2), (writeErr) => {
                ...
                res.status(201).json({ mensaje: '¡Postulación guardada con éxito!', db });
            });
        } catch (e) {
